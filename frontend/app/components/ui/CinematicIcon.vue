...
import Bolt from '~icons/lucide/zap'
...
import Clock from '~icons/lucide/clock-3'
...
const iconComponents: Record<CinematicIconName, Component> = {
  'ai': BrainCircuit,
...
<template>
  <component
    :is="iconComponent"
    class="cinematic-icon"
    :class="filled && 'cinematic-icon--filled'"
