...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'revayato'),
        'USER': os.environ.get('POSTGRES_USER', 'revayato'),
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'change-me-in-production'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Revayato API',
    'DESCRIPTION': 'API for Movie and Series Platform',
    'VERSION': '1.0.0',
...
CORS_ALLOWED_ORIGINS = os.environ.get('CORS_ALLOWED_ORIGINS', SITE_BASE_URL).split(',')
